...
#[tokio::test]
async fn test_tls_client_hello_initiated_with_correct_header() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let server_handle = tokio::spawn(async move {
        ...
        assert!(bytes_read > 5, "Client should have sent at least a TLS record header");
    ...
    let socket_addr = SocketAddr::new(std::net::IpAddr::V4(std::net::Ipv4Addr::new(127, 0, 0, 1)), port);
